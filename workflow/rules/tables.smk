...
rule merge_grid_pheno_tables:
    ...
    run:
        ...
        def row_func(row):
            ...
            row['xpos'] = float(row['xpos']) + box.pos1[0]
            row['ypos'] = float(row['ypos']) + box.pos1[1]
            row['bbox_x1'] = int(row['bbox_x1']) + box.pos1[0]
            row['bbox_x2'] = int(row['bbox_x2']) + box.pos1[0]
            row['bbox_y1'] = int(row['bbox_y1']) + box.pos1[1]
            row['bbox_y2'] = int(row['bbox_y2']) + box.pos1[1]
